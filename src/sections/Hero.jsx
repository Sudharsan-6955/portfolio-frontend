...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-10 w-full max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2 md:gap-0 pt-8 pb-4 md:pt-0 md:pb-0 ${darkMode ? "text-neutral-100" : "text-gray-900"}`}
        style={{paddingLeft: '1rem', paddingRight: '1rem'}}
      >
            {/* Left Side: Headings, Buttons, Socials */}
            <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-center text-center md:text-left px-4 sm:px-6 md:px-16 py-5 md:py-0 ">
              <h2
                ref={nameRef}
              ...
              <h3
                ref={roleRef}
                className="text-xs sm:text-lg md:text-2xl font-light min-h-[1.5rem] sm:min-h-[2.5rem] font-['Poppins'] mb-4 sm:mb-6"
              >
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center md:justify-end flex-shrink-0 md:pr-8 lg:pr-16">
              ...
              100% { transform: translateY(0); }
                ...
                <img
                  ...
                  alt="Admin Avatar"
                  className="w-24 h-24 sm:w-40 sm:h-40 md:w-72 md:h-72 bg-transparent rounded-b-full ease-in-out smooth-bounce-img"
